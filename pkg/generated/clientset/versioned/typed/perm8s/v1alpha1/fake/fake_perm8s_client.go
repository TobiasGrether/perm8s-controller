...
import (
	v1alpha1 "perm8s/pkg/generated/clientset/versioned/typed/perm8s/v1alpha1"

	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakePerm8sV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakePerm8sV1alpha1) RESTClient() rest.Interface {
