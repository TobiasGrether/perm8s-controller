	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Perm8sV1alpha1().Users(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Perm8sV1alpha1().Users(namespace).Watch(context.TODO(), options)
			},
		},
		&perm8sv1alpha1.User{},
		resyncPeriod,
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&perm8sv1alpha1.User{}, f.defaultInformer)
}
